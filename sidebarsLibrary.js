...
const sidebars = {
  ...
  supabase: [
      ...
      items: [
        {
          type: "doc",
          label: "Log In",
          id: "modules/supabase/nodes/auth/log-in",
        },
        {
          type: "doc",
          label: "Log Out",
          id: "modules/supabase/nodes/auth/log-out",
        },
        {
          type: "doc",
          label: "User",
          id: "modules/supabase/nodes/auth/user",
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          id: "modules/supabase/nodes/data/delete-records",
        },
        {
          type: "doc",
          label: "Query Records",
          id: "modules/supabase/nodes/data/query-records",
        },
        {
          type: "doc",
          label: "Update Records",
          id: "modules/supabase/nodes/data/update-records",
        },
      ],
    },
    {
      ...
      items: [
        {
          type: "doc",
          label: "Call Edge Function",
          id: "modules/supabase/nodes/edge-functions/call-edge-function",
        },
      ],
    },
    {
      ...
      items: [
        ...
        {
          type: "doc",
          label: "Client Event Delete Records",
          id: "modules/supabase/nodes/events/delete-records",
        },
        {
          type: "doc",
    ...
    },
    {
      type: "doc",
      label: "Release Notes",
      id: "modules/supabase/release-notes",
    },
    {
      type: "link",
      label: "Back to modules",
