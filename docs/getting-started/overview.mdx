...
FluxScape has two fundamental parts:
...
Getting started with FluxScape is easy. There are interactive lessons built into the tool that are a great starting point. In the documentation we recommend the following articles to get started.
...
- Then dive into the [Guides](/docs/learn) section and start digging into the wonderful world on FluxScape.

Also don't forget to check out our [Community channels](https://www.fluxscape.io/) - great ways to learn and make new friends!
